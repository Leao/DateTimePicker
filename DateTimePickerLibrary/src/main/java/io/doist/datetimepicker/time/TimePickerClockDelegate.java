...
class TimePickerClockDelegate extends TimePicker.AbstractTimePickerDelegate implements
    ...
    public TimePickerClockDelegate(TimePicker delegator, Context context, AttributeSet attrs,
        ...
        mHourView.setTextColor(ViewStateUtils.addStateIfMissing(
                mHourView.getTextColors(), android.R.attr.state_selected, headerSelectedTextColor));
        mMinuteView.setTextColor(ViewStateUtils.addStateIfMissing(
                mMinuteView.getTextColors(), android.R.attr.state_selected, headerSelectedTextColor));
